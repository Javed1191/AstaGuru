...
public class cCtrlDateTimePickerFragment extends DialogFragment implements OnDateChangedListener, OnTimeChangedListener {
    ...
    // Constructor start
    public cCtrlDateTimePickerFragment(Activity activity) {
        this(activity, DATE_TIME_PICKER);
    }

    public cCtrlDateTimePickerFragment(Activity activity, int DialogType) {
        ...
        mView = inflater.inflate(R.layout.datetimepicker, null);  
                ...
                .setNegativeButton("Cancel",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                cCtrlDateTimePickerFragment.this.getDialog().cancel();
                            }
                        }); 
