...
import com.infomanav.astaguru.Model_Search;
...
public class Search_Adpter extends ArrayAdapter<Model_Search> {
    private MainActivity mainActivity;
    LinearLayout lin_front, lin_back;
    ImageView iv_oncce, expandedImageView, iv_zoom, iv_close,iv_addtogallary,iv_remove;
    ...
    public Search_Adpter(Context context, int textViewResourceId, List<Model_Search> objects,final boolean is_us) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (curView == null) {
            ...
            curView = vi.inflate(R.layout.search_single, null);

        }

        final Model_Search cp = getItem(position);
